  ...
  return (
    <div className="legal-section-title">
      <h1 className="legal-siteTitle">
        <Link to="/">
          Hospital <span className="legal-siteSign">+</span>
        </Link>
      </h1>
      ...
      <div className="legal-text-content">
        ...
        <p className="legal-description">
          Welcome to Hospital plus, your trusted online healthcare platform. Our
        ...
        <p className="legal-description">
          When using Hospital plus, you agree to our Terms of Service. This
        ...
        <p className="legal-description">
          Hospital plus is designed to simplify healthcare access. You can choose
      ...
      <div className="legal-footer">
        <p>© 2013-2023 Hospital+. All rights reserved.</p>
      </div>
    </div>
  );
}
